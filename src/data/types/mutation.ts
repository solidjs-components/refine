import type { MutateOptions, CreateMutationResult as UseMutationResultBase } from '@tanstack/solid-query'
...
export type MutateFunction<
    ...
    TVariables = void,
    TContext = unknown,
> = (...args: Parameters<MutateAsyncFunction<TData, TError, TVariables, TContext>>) => void
...
export type UseMutationResult<
    ...
    TVariables = unknown,
    TContext = unknown,
> = Omit<UseMutationResultBase<TData, TError, TVariables, TContext>, 'mutate' | 'mutateAsync'> & {
